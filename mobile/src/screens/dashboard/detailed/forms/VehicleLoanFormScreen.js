...
const DOC_REGISTRY = {
    ...
    "Vehicle Quotation": { key: "QUOTATION", label: "Vehicle Quotation", multiple: false },
...
const DOC_MAP = {
    "Salaried Person": ["Aadhar Card", "PAN Card", "3 Months Salary Slip", "2 Years Form 16", "6 Months Banking Statement", "Address Proof", "Photograph", "Vehicle Quotation"],
    "Self Employed": ["Aadhar Card", "PAN Card", "Udyam Registration", "Shop Act Licence", "1 Current Banking Statement", "Saving Bank Account", "3 Years ITR", "GST Certificate", "Last 12 Months GST Returns", "Photograph", "Vehicle Quotation"],
};
...
export default function VehicleLoanFormScreen() {
    const navigation = useNavigation();
    const [step, setStep] = useState(1);
    const [leadId, setLeadId] = useState(null);
    const [form, setForm] = useState({
        clientName: "", phone: "", email: "", dob: "", location: "",
        loanAmount: "", employmentType: "", hasOtherLoan: "", isNewVehicle: "", otherLoanAmount: ""
    });
    ...
    const validateStep1 = () => {
        ...
        req("isNewVehicle", "Select vehicle type");
    ...
    const renderStep1 = () => (
        <View style={styles.formContainer}>
            <View style={styles.card}>
                <Text style={styles.cardHeader}>Personal & Vehicle Details</Text>
                <CustomPicker label="Vehicle Information" required value={form.isNewVehicle} options={["New Vehicle", "Used Vehicle"]} onSelect={v => handleInputChange("isNewVehicle", v)} error={errors.isNewVehicle} />
            ...
            <View style={styles.card}>
                ...
                <CustomPicker label="Employment Type" required value={form.employmentType} options={["Salaried Person", "Self Employed"]} onSelect={v => handleInputChange("employmentType", v)} error={errors.employmentType} />
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <View>
                    <Text style={styles.headerTitle}>Vehicle Loan Application</Text>
